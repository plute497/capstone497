...
const getImage = name => {
	switch (name) {
		...
		case "elks":
			return BackElks;
		case "esther":
			return BackEstherShort;
		case "evergreen":
			return BackEvergreen;
		case "heritage":
			return BackHeritage;
		case "hidden":
			return BackHidden;
		case "kiggins":
			return BackKiggins;
		case "providence":
			return BackProvidence;
		case "schofield":
			return BackSchofield;
		case "slocum":
			return BackSlocum;
		case "smith":
			return BackSmith;
...
const getAudio = name => {
	switch (name) {
		...
		case "elks":
			return AudioElks;
		case "evergreen":
			return AudioEvergreen;
		case "heritage":
			return AudioHeritage;
		case "providence":
			return AudioProvidence;
		case "schofield":
			return AudioSchofield;
		case "smith":
			return AudioSmith;
	}
};
